...
const editorialCues = Object.freeze({
  ...
  "carnotaurus-sastrei": "눈 위 뿔과 짧은 주둥이 실루엣이 완구·어린이 콘텐츠에서 널리 반복되는 종",
  "carcharodontosaurus-saharicus": "상어 이빨을 뜻하는 이름과 거대한 아프리카 포식자 단서로 도감에서 반복되는 종",
  "giganotosaurus-carolinii": "티라노사우루스와 크기를 비교하는 남미 거대 포식자로 어린이 콘텐츠에 널리 노출되는 종",
  ...
  "iguanodon-bernissartensis": "엄지 가시와 공룡 발견사 이야기로 여러 세대의 어린이 도감에서 반복되는 대표 종",
