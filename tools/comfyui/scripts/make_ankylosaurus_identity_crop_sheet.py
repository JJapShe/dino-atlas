...
DEFAULT_OUTPUT = ROOT / "assets" / "dinosaurs" / "ankylosaurus-identity-crops-v1.png"


CROPS = [
    ("full body", (0, 120, 1152, 705)),
    ("head + shoulder armor", (740, 250, 1120, 560)),
    ("dorsal armor ridge", (330, 250, 860, 430)),
    ("tail club", (0, 320, 290, 540)),
    ("four-leg stance", (260, 455, 900, 735)),
]
...
def make_sheet(items, output):
    ...
    draw.rectangle((0, 0, sheet_w, header_h), fill=(75, 73, 58))
    draw.text((20, 18), "Ankylosaurus identity review crops", fill=(248, 246, 239), font=font)
    draw.text((20, 40), "Check broad low body, four legs, low armor, attached tail club, and non-crocodile head.", fill=(226, 224, 210), font=font)
