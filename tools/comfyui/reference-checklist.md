...
- rear-view or frontal-view pose hides the side-profile shoulder-to-hip slope
- feet, tail tip, or head are cropped or hidden enough to block anatomy review
- the head becomes crocodile-like, toothy, or predator-like
- the animal rears up, becomes bipedal, or loses quadrupedal ground contact

Temporary app rule:

- Keep `brachiosaurus-altithorax-imagegen-v16-source-candidate.png` first because it is the first current-route candidate that keeps the high shoulders, visibly taller forelimbs, shoulder-to-hip trunk slope, long rising neck, four reviewable feet, and small herbivore head while also giving a clearly short thick tapering tail. Keep `brachiosaurus-p3-v15-v17-review-sheet.png` and `brachiosaurus-p3-v15-v17-crops.png` directly below it as the close-review gates. Keep the previous first `brachiosaurus-altithorax-tail-reduced-i2i-v4.png`, `brachiosaurus-tail-reduced-i2i-crops-v4.png`, and `brachiosaurus-review-options-v7.png` as positive comparisons, then keep `brachiosaurus-altithorax-highshoulder-bodylock-guide-v1.png`, `brachiosaurus-highshoulder-bodylock-crops-v8.png`, and `brachiosaurus-review-options-v8.png` as the next structure-control route for preventing Apatosaurus/Diplodocus drift. Keep `brachiosaurus-altithorax-highshoulder-shorttail-imagegen-v3.png`, `brachiosaurus-altithorax-tallforelimb-shorttail-imagegen-v3.png`, `brachiosaurus-altithorax-balancedneck-imagegen-v2.png`, `brachiosaurus-altithorax-moderateneck-comparison-v2.png`, `brachiosaurus-altithorax-highshoulder-imagegen-v1.png`, `brachiosaurus-altithorax-realvis-v2.png`, `brachiosaurus-altithorax-highshoulder-sideprofile-v1.png`, and the ControlNet/IP-Control outputs as comparison gates. Do not mark the taxon final until skull proportions, tail-base shape, and exact sauropod foot detail pass reference review.
...
- 2026-07-02 P3 v15-v17 follow-up: promote `brachiosaurus-altithorax-imagegen-v16-source-candidate.png` to the current count-level pass and keep `brachiosaurus-p3-v15-v17-review-sheet.png` plus `brachiosaurus-p3-v15-v17-crops.png` as the latest decision sheets. V16 improves the recurring tail failure by pairing a compact short thick tail with the high-shoulder/taller-forelimb Brachiosaurus body plan and four reviewable feet. Keep the previous v4 as a review hold rather than first image, keep v17 as a secondary short-tail hold, and keep v15 as a long-tail hold. Do not mark final until exact skull, foot, and tail-base anatomy pass close reference review.
